 ...
 */
@WebServlet("/api/quick/account/data/CBU/*")
public class CuentaPorCBU extends BaseServlet implements Servlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Response<Cuenta> res = (new CuentaLogicImpl()).getByCBU(CBU);
