...
public class Administrador implements IEntity {
	...
	public static final Schema _schema = new Schema(
		...
		new SchemaProperty("nombre_admin") {{
			required = true;
			type = Types.VARCHAR;
			maxlength = 48;
			minlength = 1;
		...
		new SchemaProperty("apellido_admin") {{
			required = true;
			type = Types.VARCHAR;
			maxlength = 48;
			minlength = 1;
		...
		new SchemaProperty("nacionalidad_admin") {{
			required = true;
			type = Types.VARCHAR;
			maxlength = 2;
		...
		new SchemaProperty("direccion_admin") {{
			required = true;
			type = Types.VARCHAR;
			maxlength = 128;
			minlength = 1;
		...
		new SchemaProperty("hash_admin") {{
			required = true;
			select = false;
			type = Types.VARBINARY;
			maxlength = 64;
		}},
		new SchemaProperty("salt_admin") {{
			required = true;
			select = false;
			type = Types.VARBINARY;
			maxlength = 24;
		}},
		new SchemaProperty("estado_admin") {{
			required = true;
			type = Types.BOOLEAN;
			defaultValue = true;
		}}
