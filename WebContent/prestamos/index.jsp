...
<main class="mdc-top-app-bar--fixed-adjust">
    ...
    <span>Cuotas pagadas
			<button id="pagarCuota" class="mdc-button mdc-button--raised mdc-button--icon-leading">
			  ...
			  <i class="material-symbols-outlined mdc-button__icon" aria-hidden="true">add</i>
        ...
        <!--div class="mdc-data-table__pagination">
          <div class="mdc-data-table__pagination-trailing">
            ...
            <div class="mdc-data-table__pagination-navigation">
              ...
              <button class="mdc-icon-button material-symbols-outlined mdc-data-table__pagination-button" data-prev-page="true" id="tablaCuotasPagadas__btnAnterior">
                <div class="mdc-button__icon">chevron_left</div>
              </button>
              <button id="tablaCuotasPagadas__btnSiguiente" class="mdc-icon-button material-symbols-outlined mdc-data-table__pagination-button" data-next-page="true">
    ...
    <div class="mdc-dialog__container">
        <div class="mdc-dialog__surface" role="alertdialog" aria-modal="true" aria-labelledby="my-dialog-title"
            ...
            <div class="mdc-dialog__actions">
                ...
                <button type="button" id="continuarBtn" class="mdc-button mdc-dialog__button"
