    ...
    <div class="nav-wrapper">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li>
        	...
        	<li><a href="/TPINT_GRUPO_3_LAB/prestamos/solicitarPrestamo.jsp">Solicitar préstamo</a></li>
        	<li class="divider"></li>
        	<li><a href="#">Préstamos otorgados</a></li>
        	<li class="divider"></li>
        	<li><a href="/TPINT_GRUPO_3_LAB/prestamos/pagoPrestamo.jsp">Pago de préstamo</a></li>
        	<li class="divider"></li>        
 			</ul>
        </li>
        ...
        <div id="tab-login" class="__login-card--tab _visible">
          ...
          <div class="_body">
            ...
            <label id="tU" class="mdc-text-field mdc-text-field--outlined">
              ...
              <input type="text" id="code" name="code" class="mdc-text-field__input" required aria-labelledby="lblUsername">
            </label>
