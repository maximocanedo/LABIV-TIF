                ...
                <div class="mdc-layout-grid__inner">
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12 full-width">
                        <label class="mdc-text-field mdc-text-field--filled">
                            ...
                            <input name="montoTotal" step="1" required min="1" value="1" class="mdc-text-field__input"
                                   type="number" aria-labelledby="my-label-id">
                            <span class="mdc-text-field__affix mdc-text-field__affix--suffix">.00</span>
                            <span class="mdc-line-ripple"></span>
                        </label>
                    </div>
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12">
                        <div id="tipusDestinoSegmentedButton"
                             class="mdc-segmented-button mdc-segmented-button--single-select full-width"
                             role="radiogroup">
                    ...
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12">
                        <label class="mdc-text-field mdc-text-field--filled full-width">
                            ...
                            <input class="mdc-text-field__input" name="idCuentaDestino" type="text" aria-label="label"
                                   aria-labelledby="idCuentaDestinoLabel">
                            <span class="mdc-line-ripple"></span>
                        </label>
                    </div>
                    <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12">
