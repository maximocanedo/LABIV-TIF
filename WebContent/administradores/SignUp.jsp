    ...
    <form action="#" name="signup" method="POST">
        <div class="mdc-card __signup-card">
                            ...
                            <span class="mdc-notched-outline">
                                ...
                                <span class="mdc-notched-outline__notch">
                                    <span class="mdc-floating-label"
                                          id="lblClave2">Volvé a escribir la contraseña</span>
                                </span>
                                <span class="mdc-notched-outline__trailing"></span>
                            </span>
                        <input type="password" minlength="8"
            ...
            <div id="tab-sexo" class="__signup-card--tab">
                ...
                <div class="_body">
                    ...
                    <div class="mdc-form-field" id="mdffSexo">
                        <div class="mdc-radio">
                            <input class="mdc-radio__native-control" type="radio" id="radioSexoMasculino" name="sex"
                                   value="M"
                                   required selected>
                        ...
                        <div class="mdc-radio">
                            <input class="mdc-radio__native-control" type="radio" id="radioSexoFemenino" name="sex"
                                   value="F"
                                   required>
                            <div class="mdc-radio__background">
                                <div class="mdc-radio__outer-circle"></div>
            ...
            <div id="tab-error" class="__signup-card--tab">
                ...
                <div class="_footer">
                    <div class="mdc-touch-target-wrapper">
                        <button id="btnLogin2" onclick="window.location = './../clientes/login.jsp';"
