...
const showBanner = () => {
    material.showBanner(
        "Verificá tu correo electrónico para realizar transacciones. ",
        {
            text: "Verificar",
            handler: (e) => console.log(32),
        }
    );
};

window.eee = () => {
    material.showBanner("Verificá 44. ", {
        text: "Verificar",
        handler: (e) => console.log(44),
    });
};
...
(async () => {
    ...
    document
        .querySelector("#myProfileButton")
        .addEventListener("click", openMyProfileDialog);
